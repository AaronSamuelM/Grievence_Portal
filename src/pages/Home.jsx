...
const Home = () => {
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <main className="flex flex-1 px-8 py-6 bg-gray-100 gap-6">
        {/* About Section with Image */}
        <div className="flex-1 bg-gray-100 p-6 rounded-lg shadow-lg flex items-center gap-6">
...
/>
        ...
        <aside className="block p-2 rounded text-blue-700 font-medium hover:bg-blue-100 hover:text-blue-900 transition duration-200"
>
          {/* Useful Links */}
