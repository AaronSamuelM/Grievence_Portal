...
const faqs = [
  {
    q: "How can I raise a grievance?",
    a: "You can log in to the portal, click 'Raise Grievance', fill the form with details, and submit. You’ll receive a tracking ID instantly.",
  },
  {
    q: "Can I submit without logging in?",
    a: "For better tracking and updates, login is recommended. However, you may still submit via email or WhatsApp.",
  },
  {
    q: "What documents are required?",
    a: "It depends on the nature of your grievance. Identity proof and supporting evidence (photos, bills, notices) are usually helpful.",
  },
  {
    q: "How long does it take to resolve a grievance?",
    a: "Resolution time varies by department, but most grievances are addressed within 7–15 working days.",
  },
  {
    q: "Can I edit my grievance after submission?",
    a: "Once submitted, grievances cannot be edited, but you may submit additional documents or clarifications.",
  },
];
    ...
    <div className="flex flex-col">
      ...
      <section className="px-4 md:px-8 lg:px-20 py-10 bg-gray-100">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
          ...
          <ol className="list-decimal list-inside text-gray-700 text-base md:text-lg lg:text-xl leading-relaxed space-y-3">
            ...
            <li>
              Navigate to the <strong>Contact Us</strong> section
            </li>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-8 lg:px-20 py-10 bg-gray-50">
        <div className="bg-blue-100 p-6 rounded-lg shadow-lg text-center hover:bg-blue-200 transition-all duration-300">
          <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-[#22406d] mb-3">
            📧 Email
          </h3>
        ...
        <div className="bg-green-100 p-6 rounded-lg shadow-lg text-center hover:bg-green-200 transition-all duration-300">
          <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-green-700 mb-3">
            📱 WhatsApp
          </h3>
        ...
        <div className="bg-yellow-100 p-6 rounded-lg shadow-lg text-center hover:bg-yellow-200 transition-all duration-300">
          <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-yellow-700 mb-3">
            ☎️ Helpline
          </h3>
      ...
      <section className="px-4 md:px-8 lg:px-20 py-10 bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqs.map((item, index) => (
            <div
              key={index}
              className="bg-white p-4 rounded-lg shadow-lg hover:bg-gray-100 transition-all"
            >
              <button
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-8 lg:px-20 py-10 bg-gray-100">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:bg-gray-200 transition-all">
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-[#22406d] mb-3">
            Quick Response
          </h3>
          <p className="text-gray-600 text-sm md:text-base">
            Most queries are resolved within 24–48 hours.
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:bg-gray-200 transition-all">
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-[#22406d] mb-3">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Email, WhatsApp, and Helpline available for ease.
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:bg-gray-200 transition-all">
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-[#22406d] mb-3">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Unresolved issues are auto-escalated to higher officials.
          </p>
        </div>
      </section>
    </div>
